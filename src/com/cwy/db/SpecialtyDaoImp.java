...
public class SpecialtyDaoImp implements BaseDao<Specialty> {
    ...
    private static final String SQL_INSERT = "insert into cwy_specialty(userid,name,description) values(?,?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from cwy_specialty where userid=?";

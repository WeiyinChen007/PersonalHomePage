...
public class EduDaoImp implements BaseDao<Edu> {
    ...
    private static final String SQL_INSERT = "insert into cwy_edu(userid,start,end,school,study,description) values(?,?,?,?,?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from cwy_edu where userid=? order by start";

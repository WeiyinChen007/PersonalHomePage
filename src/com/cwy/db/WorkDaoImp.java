...
public class WorkDaoImp implements BaseDao<Work> {
    ...
    private static final String SQL_INSERT = "insert into cwy_work(userid,start,end,company,job,description) values(?,?,?,?,?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from cwy_work where userid=? order by start";

...
public class SkillDaoImp implements BaseDao<Skill> {
    ...
    private static final String SQL_INSERT = "insert into cwy_skill(userid,keywords) values(?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from cwy_skill where userid=?";
